...
import { Mail, Lock, User, Eye, EyeOff, ArrowLeft, CircleAlert as AlertCircle, CircleCheck as CheckCircle2 } from "lucide-react";
      ...
      <AnimatePresence mode="wait">
        {mode === "landing" && (
          <motion.div key="landing" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="relative z-10 w-full max-w-sm px-6 flex flex-col items-center gap-5">
            ...
            <button data-testid="btn-google-login" onClick={handleGoogle} disabled={loading} className="w-full flex items-center justify-center gap-3 bg-white text-black rounded-xl py-3 font-display font-semibold text-sm hover:bg-white/90 transition disabled:opacity-50">
